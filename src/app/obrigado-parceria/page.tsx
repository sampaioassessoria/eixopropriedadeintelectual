...
export default function ThankYouPartnership() {
    return (
        <div className="relative min-h-[calc(100vh-200px)] flex items-center justify-center overflow-hidden bg-gradient-to-b from-[#1a9cea] via-[#2b90e9] to-[#bfdbfe] pt-24">
          ...
          `,
            ...
            <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
                <h1 className="text-4xl md:text-6xl font-bold text-black mb-8 leading-tight">
                    Sua solicitação de parceria foi<br />
                    enviada com sucesso!
                </h1>
